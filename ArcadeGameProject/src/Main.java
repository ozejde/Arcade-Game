...
public class Main {
	...
	public void instuctSetup(){
		...
		JLabel manualLabel = new JLabel("<html>Controls"
				+" <br> • Press the arrow keys to move"
				+ "<br> • Press B to drop bombs"
				+ "<br> • Press U to play the next level, and D to play the previous level"
				+ "<br> • Press Z to detonate controllable bombs (Power-up ability) "
				+ "<br> "
				+ "<br> General Rules"
				+ "<br> • You cannot pass through brick or concrete walls"
				...
				+ "<br> • You can only gain lives through certain powerups"
				+ "<br>"
				+ "<br>Power-Ups"
				+ "<br> • Purple tiles add a life"
				+ "<br> • Red tiles make the bombs detonatable"
